...
* Enregistrez et partagez des vidéos (ainsi que des photos) de vos expériences de réalité mixte.
...
Pour voir si votre PC peut exécuter Windows Mixed Reality, passez en revue les instructions matérielles ci-dessous et exécutez l' [application portail de réalité mixte](https://www.microsoft.com/store/apps/9NG1H8B3ZC7M).

Rappelez-vous que vos performances varient en fonction de votre configuration exacte. Vous devez également vous assurer que votre ordinateur dispose des [ports appropriés](recommended-adapters-for-windows-mixed-reality-capable-pcs.md) pour le casque immersif Windows Mixed realisation que vous utilisez.
...
* **Prend en charge certaines fonctionnalités.** Ce PC peut être en mesure d’exécuter Windows Mixed Reality, mais certaines fonctionnalités peuvent être limitées.
...
En raison de la résolution plus élevée, les exigences suivantes s’appliquent à la réverbération HP G1 & les gammes de produits G2 pour garantir une expérience de 90Hz optimale et de résolution complète : 
...
Pour tous les autres HMD, reportez-vous aux exigences suivantes : 
...
<tr>
    ...
    <td style="vertical-align: middle; text-align: center;">DDR3 de 8 Go (ou meilleure)</td>
    <td style="vertical-align: middle; text-align: center;">8 Go de mémoire à double canal DDR3 (ou plus)</td>
</tr><tr>
...
* Les plus grands ordinateurs portables (avec des écrans d’au moins 15 ") fonctionnent mieux.
...
Pour une expérience Windows Mixed Reality optimale sur un appareil surface, nous recommandons le SurfaceBook 2 (15) configuré avec la NVIDIA GeForce GTX 1060 et 16 Go de RAM.  Cette configuration prend en charge toutes les fonctionnalités de Windows Mixed Reality @ 90Hz et a été testée et soumise à des badges pour Windows Mixed Reality ultra.  Le livre surface 2 (13), surface Studio, portable surface et surface Pro (2017) prend en charge certaines fonctionnalités de la réalité Windows mixte lorsqu’il est configuré avec un processeur Intel Core i5 (ou mieux) et au moins 8 Go de RAM.
...
<tr>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><b>Remarque</b>: le livre surface 2 (13) n’a pas de badge pour Windows Mixed Reality, mais prend en charge certaines fonctionnalités de Windows Mixed realisation, ce qui vous permet d’utiliser un nombre limité d’applications et de jeux compatibles.  Les performances dépendent de votre configuration.</li>
                <li>Les configurations avec un GPU Intel Core i5/Intel HD Graphics 620 intégré offrent une expérience Windows Mixed Reality à 60 Hz.</li>
                <li>Les configurations avec un GPU discret 1050 Intel Core i7/NVIDIA GeForce GTX offriront une expérience Windows Mixed Reality @ 90Hz</li>                       <li>Pour des performances optimales, utilisez les pilotes graphiques NVIDIA fournis spécifiquement pour surface Book 2. Des pilotes plus récents peuvent être disponibles sur le site Web NVIDIA&#39;s, mais ils ne sont pas testés.</li>
                ...
                <li><b>Remarque sur la station d’accueil</b>: l’utilisation du Dock de surface avec le livre surface 2 n’est pas officiellement prise en charge avec Windows Mixed Reality, en raison des limitations de l’alimentation de l’ancrage de surface.</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><b>Remarque</b>: surface Studio n’a pas de badge pour Windows Mixed Reality, mais prend en charge certaines fonctionnalités Windows Mixed realisation, ce qui vous permet d’utiliser un nombre limité d’applications et de jeux compatibles.  Les performances dépendent de votre configuration.</li>
                <li>Les configurations avec NVIDIA GeForce GTX 965m offriront une expérience Windows Mixed Reality à 60 Hz.</li>
                <li>Les configurations avec NVIDIA GeForce GTX 980m offriront une expérience Windows Mixed Reality @ 90Hz.</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><b>Remarque</b>: le Pro Surface (2017) n’a pas de badge pour Windows Mixed Reality, mais prend en charge certaines fonctionnalités de Windows Mixed realisation, ce qui vous permet d’utiliser un nombre limité d’applications et de jeux compatibles.  Les performances dépendent de votre configuration.</li>
                <li>Les configurations avec un GPU intégré Intel Core m3/Intel HD Graphics 615 ne sont <b>pas prises en charge</b></li>
                <li>Les configurations avec un GPU Intel Core i5/Intel HD Graphics 620 intégré offrent une expérience Windows Mixed Reality à 60 Hz.</li>
                <li>Les configurations avec un GPU Intel Core i7/Intel® IRIS™ plus Graphics 640 intégré offrent une expérience Windows Mixed Reality à 60 Hz.</li><br/><li>Nécessite surface Mini DisplayPort sur l’adaptateur HDMI 2,0 (les autres adaptateurs peuvent fonctionner, mais ils ne sont pas testés)</li>
        ...
        <td>
            <ul>
                <li><b>Remarque</b>: l’ordinateur portable n’a pas de badge pour Windows Mixed Reality, mais prend en charge certaines fonctionnalités de Windows Mixed realisation, ce qui vous permet d’utiliser un nombre limité d’applications et de jeux compatibles.  Les performances dépendent de votre configuration.</li>
                <li>Les configurations avec un GPU intégré Intel Core m3/Intel HD Graphics 615 ne sont <b>pas prises en charge</b></li>
                <li>Les configurations avec un GPU Intel Core i5/Intel HD Graphics 620 intégré offrent une expérience Windows Mixed Reality à 60 Hz.</li>
                <li>Les configurations avec un GPU Intel Core i7/Intel® IRIS™ plus Graphics 640 intégré offrent une expérience Windows Mixed Reality à 60 Hz.</li><br/><li>Nécessite surface Mini DisplayPort sur l’adaptateur HDMI 2,0 (les autres adaptateurs peuvent fonctionner, mais ils ne sont pas testés)</li>
                <li>Nécessite un <a href="https://support.microsoft.com/en-us/help/4023450/surface-surface-battery-and-power">curseur de performances</a> défini sur « meilleures performances » lors de l’utilisation</li>
