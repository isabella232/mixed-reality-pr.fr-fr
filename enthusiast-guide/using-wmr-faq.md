...
Windows Mixed Reality est conçu pour émettre du son via votre casque immersif lorsque vous l’utilisez et que vous y êtes connecté. Quand vous déconnectez le casque ou retournez la visière, l’audio bascule sur votre appareil de lecture Windows par défaut. Vous pouvez modifier ce paramètre dans **paramètres > la réalité mixte > l’audio et la parole**.
...
Si votre casque n’a pas de MIC intégré, attachez une paire de casque avec un micro à votre casque ou PC. Sélectionnez **paramètres > réalité mixte > l’audio et la parole** pour basculer automatiquement votre entrée MIC sur votre casque lorsque votre casque est connecté. Assurez-vous que **lorsque j’utilise mon casque, basculez vers le micro-casque** activé.
...
Si vos contrôleurs de mouvement ne fonctionnent pas correctement, ne vous connectez pas, ou si vous ne voyez pas d’image des contrôleurs quand vous utilisez votre casque :
...
* Si vous utilisez le Wi-Fi, essayez de connecter votre PC à un réseau Wi-Fi de 5 GHz pour réduire les interférences sans fil. 
...
* Pour les casques plus anciens qui ne disposent pas de Bluetooth intégré, les contrôleurs doivent être couplés directement :  
    ...
    * Si vous utilisez une carte Bluetooth USB, assurez-vous qu’elle est connectée à un port USB noir 2,0. Assurez-vous également que la carte est branchée le plus loin possible de tout autre transmetteur sans fil ou disque mémoire flash USB, y compris le connecteur USB pour votre casque. 
...
Si vos visuels de réalité mixte n’ont pas la meilleure apparence :
...
* Basculez vers une connexion de Wi-Fi de 5 GHz, si celle-ci est disponible. [En savoir plus](https://support.microsoft.com/help/4000461)
...
Le paramètre options d’expérience (**paramètres > réalité mixte > affichage du casque > options d’expérience**) vous donne la possibilité de modifier les paramètres de performances de Windows Mixed Reality. Cela vous permet de choisir la meilleure expérience possible pour votre configuration matérielle dans une plage de contenu. L’expérience 90 Hz est disponible pour tous les systèmes, mais vous pouvez essayer d’utiliser la fonctionnalité automatique pour déterminer le paramètre de votre choix.
...
* 90 Hz : définit la fréquence d’actualisation à 90 Hz si votre casque peut s’exécuter à cette vitesse. Si les problèmes de câble empêchent l’exécution du casque à 90 Hz, vous pouvez voir une erreur au démarrage avec ce mode sélectionné. 
