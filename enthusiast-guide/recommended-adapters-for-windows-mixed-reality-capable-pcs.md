...
<table>
<tr>
<th style="width:30%">Type</th><th style="width:40%">Adaptateur</th><th style="width:15%">compatibilité 60 Hz</th><th style="width:15%">compatibilité 90Hz</th>
</tr><tr>
...
<td>Le câble présente un adaptateur DisplayPort actif à l’adaptateur HDMI prenant en charge 4 000 Hz</td><td style="text-align: center; vertical-align: middle;">✔️</td><td style="text-align: center; vertical-align: middle;">✔️</td>
</tr><tr>
...
<td>Mini-DisplayPort enfichable vers Active HDMI 2,0 </td><td style="text-align: center;">✔️</td><td style="text-align: center;">✔️</td>
</tr><tr>
<td>Cables actif Mini DisplayPort pour adaptateur HDMI prenant en charge 4 Ko 60 Hz</td><td style="text-align: center; vertical-align: middle;">✔️</td><td style="text-align: center; vertical-align: middle;">✔️</td>
</tr><tr>
<td style="vertical-align: middle;">USB 3,0 type-C (à utiliser avec Microsoft surface Book 2)</td><td>Adaptateur USB-C vers HDMI (prend en charge l’interface HDMI 2,0)</td><td style="text-align: center;">✔️</td><td style="text-align: center;">✔️</td>
</tr><tr>
...
<td>Plugable USB-C vers HDMI 2,0 (non compatible avec Microsoft surface Book 2)</td><td style="text-align: center;">✔️</td><td style="text-align: center;">✔️</td>
</tr><tr>
...
### <a name="windows-mixed-reality-pc-60hz"></a>[PC Windows Mixed Reality (60 Hz)](Windows-Mixed-Reality-minimum-PC-hardware-compatibility-guidelines.md)
...
## <a name="windows-mixed-reality-compatible-usb-bluetooth-adapters"></a>Adaptateurs Bluetooth USB compatibles Windows Mixed Reality
...
## <a name="using-external-usb-30-hubs-with-windows-mixed-reality-headsets"></a>Utilisation de Hubs USB 3,0 externes avec des casques pour Windows Mixed Reality

Les casques Windows Mixed Reality peuvent être utilisés avec un concentrateur USB 3,0 externe si votre ordinateur ne dispose pas de suffisamment de ports USB ouverts. Le concentrateur USB 3,0 externe **doit être alimenté en externe via un adaptateur CA** afin de fournir suffisamment d’énergie au casque.
...
* Le concentrateur Multispeed USB 3,0 enfichable à 10 ports avec adaptateur d’alimentation 48W est connu pour fonctionner correctement avec les casques et la plupart des PC Windows Mixed Reality.

## <a name="see-also"></a>Voir aussi
* [Résolution des problèmes de connectivité du casque](headset-connectivity.md)
* [Instructions de compatibilité matérielle PC minimale pour Windows Mixed Reality](windows-mixed-reality-minimum-pc-hardware-compatibility-guidelines.md)
