...
Vous pouvez activer les commandes Cortana en réalité mixte, ce qui vous permet d’utiliser des commandes vocales pour vous téléporter et ouvrir des applications. Vous en apprendrez davantage sur ces actions dans le chapitre formation à la [réalité mixte](learn-mixed-reality.md) .
