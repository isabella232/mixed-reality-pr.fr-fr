...
* Vérifiez les performances et la stabilité de votre ordinateur :
    ...
    * Vérifiez les journaux « application » et « système » dans **observateur d’événements > journaux Windows** pour voir si une application se bloque et génère des rapports d’rapport D’ERREURS Windows (WER).
