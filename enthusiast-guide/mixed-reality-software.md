...
1. **Portail de réalité mixte**, qui offre l’expérience Windows Mixed Reality principale
    * Dans Windows 10, les versions 1709 et 1803, le portail de réalité mixte est un composant clé du système d’exploitation Windows 10 et est mis à jour via Windows Update.
    * Dans Windows 10, la version 1809 et les versions ultérieures, le portail de réalité mixte est mis à jour par le biais de l’application Microsoft Store.
...
En outre, l’utilisation de Windows Mixed Reality dans SteamVR requiert les logiciels suivants :
...
* Modifie le comportement du paramètre de fréquence d’actualisation 90Hz dans Windows Mixed realisation pour qu’il ne repasse plus à 60 Hz dans certains cas lorsque 90Hz ne peut pas être atteint. 
...
#### <a name="windows-10-version-1903-may-2019-update"></a>Windows 10, version 1903 (mai 2019 mise à jour) ####
   ...
   | [10.0.18362.1024](https://www.microsoft.com/en-us/download/details.aspx?id=58225)  | 1er mai 2019      | Compatible avec Windows 10, version 1809 et versions ultérieures.<br/><ul><li>Contient la mise à jour du microprogramme des casques de realisation 2017 Acer, Asus, Dell, Fujitsu, HP, Lenovo et Medion. Cette mise à jour du microprogramme améliore la compatibilité et la fiabilité de l’affichage du casque avec certaines cartes graphiques et/ou pilotes graphiques.</li><li>Améliorations de la plateforme et de la fiabilité du casque Windows Mixed Reality</li></ul>  | 
...
#### <a name="windows-10-version-1803-april-2018-update-and-version-1809-october-2018-update"></a>Windows 10, version 1803 (mise à jour d’avril 2018) et version 1809 (mise à jour d’octobre 2018) ####
   ...
   | Version          | Date de sortie          | Modifications majeures                                                 |
   |------------------|-----------------------|---------------------------------------------------------------|
   | [10.0.17763.1069](https://www.microsoft.com/en-us/download/details.aspx?id=57702)  | 2e janvier 2019      | Compatible avec Windows 10, version 1803 et versions ultérieures.<br/><ul><li>Correction du suivi des casques et des interruptions</li><li>Correctifs de fiabilité en mode lampe</li></ul>  | 
...
| Version          | Date de sortie          | Modifications majeures                                                 |
   |------------------|-----------------------|---------------------------------------------------------------|
   | [10.0.19041.2034](https://www.microsoft.com/en-us/download/details.aspx?id=102155)  | 16 septembre, 2020      | Version publique initiale du pilote pour les nouveaux contrôleurs de mouvement HP. Compatible avec Windows 10, version 1903 et versions ultérieures. Ce pilote est compatible uniquement avec les nouveaux contrôleurs de mouvement HP.  |
...
#### <a name="windows-10-version-1809-and-newer"></a>Windows 10, version 1809 et versions ultérieures ####
   ...
   | 2000.19081.1301.0  | 23 septembre 2019    | <ul><li>Résout un problème qui signale un message d’erreur incorrect dans les casques rencontrant des problèmes matériels. Les utilisateurs qui ont reçu un code d’erreur 1-4 sur les versions précédentes peuvent désormais recevoir un code d’erreur plus spécifique pour leur état d’appareil.</li></ul>  |
