...
| Caractéristique | [HoloLens (première génération)](/hololens/hololens1-hardware) | [HoloLens 2](/hololens/hololens2-hardware) | [Casques immersifs](../../discover/immersive-headset-hardware-details.md) |
| ---- | ---- | ---- | ---- |
| Mappage spatial | ✔️ | ✔️ | ❌ |
...
## <a name="how-to-add-mapping-in-unity"></a>Ajout d’un mappage dans Unity
