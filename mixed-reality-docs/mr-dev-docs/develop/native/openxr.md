...
| Interopérabilité avec d’autres SDK HoloLens<br />(par exemple, [QR](../platform-capabilities-and-apis/qr-code-tracking.md))<p>*HoloLens 2 uniquement*</p> | **`MSFT` extension publiée dans le runtime 102 :**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_spatial_graph_bridge">XR_MSFT_spatial_graph_bridge</a></code> |
...
| Interopérabilité avec l’API CoreWindow UWP<br />(par exemple, pour le clavier/la souris) | **`MSFT_preview` extension dans [preview runtime 102](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_holographic_window_attachment_preview">XR_MSFT_holographic_window_attachment_preview</a></code><p>**`MSFT` extension dans Preview runtime** : 2020 août *(planifié)*</p>
| [Modèles de rendu du contrôleur de mouvement](../../design/motion-controllers.md#rendering-the-motion-controller-model) | **`MSFT_preview` extension dans [preview Runtime](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_controller_model_preview">XR_MSFT_controller_model_preview</a></code><p>**`MSFT` extension dans Preview Runtime** : septembre 2020 *(planifié)*</p> |
| [Compréhension des scènes (plans, maillages)](../../design/scene-understanding.md)<p>*HoloLens 2 uniquement*</p> | <p>**Dans [preview runtime 102](openxr-getting-started.md#using-preview-extensions):**<br />Utiliser <code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_spatial_graph_bridge">XR_MSFT_spatial_graph_bridge</a></code> avec [Scene UNDERSTANDing SDK](../platform-capabilities-and-apis/scene-understanding-sdk.md)</p><p>**`MSFT_preview` extension dans le futur Runtime Preview** *(planifié)*</p> |
